...
namespace SwaggerValidationPoc
{
    ...
    {
        internal static bool TryFindOperationById(this OpenApiDocument openApiDocument, string operationId, out string pathTemplate, 
        ...
        internal static OpenApiOperation GetOperationByPathAndType(this OpenApiDocument openApiDocument, string pathTemplate,
            OperationType operationType, out OpenApiPathItem pathSpec)
        {
